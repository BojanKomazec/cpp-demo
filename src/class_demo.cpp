...
public:
    ...
    //
    // From: https://stackoverflow.com/questions/20828907/the-new-syntax-default-in-c11?lq=1
    // "Giving a user-defined constructor, even though it does nothing, makes the type not an aggregate
    //  and also not trivial. If you want your class to be an aggregate or a trivial type (or by
    // transitivity, a POD type), then you need to use = default."
    IntegerC() = default;
